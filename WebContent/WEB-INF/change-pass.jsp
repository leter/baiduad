...
<div class="pd-20">
	<form action="changePassWord.do" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			<label class="form-label col-4"><span class="c-red">*</span>账户名：</label>
			<div class="formControls col-4"> ${userName }</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			<label class="form-label col-4"><span class="c-red">*</span>旧密码：</label>
			<div class="formControls col-4">
				<input type="password" class="input-text" autocomplete="off" placeholder="不修改请留空" name="old-password" id="old-password" datatype="*6-18" ignore="ignore" >
...
$(function(){
	...
	$("#form-change-password").Validform({
		...
		callback:function(form){
			$("#oldPassWord").val(hex_md5($("#old-password").val()));
